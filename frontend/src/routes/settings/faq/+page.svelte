        ...
        <div class="hero bg-base-200 rounded-box min-h-[400px]">
            <div class="hero-content text-center">
                <div class="max-w-md">
                    ...
                    <p class="py-6">
                        Get started by adding your first question or helpful tip. Organize your content into categories
                            ...
                            <div class="space-y-2">
                                {#each category.tips as tip (tip.id)}
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-start gap-2">
                                                <span class="icon-[lucide--lightbulb] size-5 text-accent mt-0.5"></span>
