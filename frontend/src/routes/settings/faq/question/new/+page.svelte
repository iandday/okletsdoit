...
<ProtectedPageShell {relativeCrumbs}>
    <div class="container mx-auto p-4 max-w-4xl">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold">Add FAQ Question</h1>
            ...
            <div class="config-card-body space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control w-full">
                        ...
                        <span class="label">
                            <span class="label-text-alt">Questions are grouped by category on the FAQ page</span>
                        </span>
                    </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input
                            ...
                            required />
                        <span class="label">
                            <span class="label-text-alt">Icon displayed next to the question</span>
                        </span>
                    </div>
                </div>
