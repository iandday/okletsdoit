...
<ProtectedPageShell {relativeCrumbs}>
    <div class="container mx-auto p-4 max-w-4xl">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold">Edit FAQ Question</h1>
                <p class="text-base-content/70 mt-1">
                    Update this frequently asked question, Enter the icon's name from <a
            ...
            <a href="/settings/faq" class="btn btn-error">
