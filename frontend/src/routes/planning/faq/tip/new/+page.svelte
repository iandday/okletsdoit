<script lang="ts">
    ...
    const relativeCrumbs = [{ title: "FAQ", href: "/planning/faq" }, { title: "Add Tip" }];
</script>

<ProtectedPageShell {relativeCrumbs}>
    <ProtectedPageHeader title="Add Helpful Tip" description="Create a helpful tip to guide your guests" />
