...
export function RsvpQuestionResponseSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): RsvpQuestionResponseSchema {
    if (json == null) {
        return json;
    }
    return {
...
export function RsvpQuestionResponseSchemaToJSONTyped(value?: RsvpQuestionResponseSchema | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
